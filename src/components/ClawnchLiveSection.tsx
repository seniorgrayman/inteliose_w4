...
const ClawnchLiveSection = () => {
  ...
  return (
    <section id="clawnch-live" className="pt-4">
      <div className="flex justify-between items-start border-b border-border pb-4 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Real-time intelligence on Clawnch-deployed tokens.</p>
        </div>
        <div className="flex items-center gap-2">
                ...
                {expandedToken ? (
                  ...
                  >
                    <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center mb-4">
                      <Cat size={20} className="text-muted-foreground" />
                    </div>
...
export default ClawnchLiveSection;
