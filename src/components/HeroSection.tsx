  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-auto max-w-4xl">
        ...
        <p className="text-base font-bold md:text-lg text-white/90 max-w-2xl mb-2 md:mb-8">
          Web4 enabled intelligence to optimize your token strategy on base chain.
        </p>

        <p className="text-base text-sm md:text-lg text-white/80 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-3 justify-start">
            <Link
              ...
              className="
                ...
                px-8 py-3.5 rounded-2xl text-sm font-display font-semibold 
                transition-all 
            ...
            <Link
              ...
              className="
                ...
                px-8 py-3.5 rounded-2xl text-sm font-display font-medium 
