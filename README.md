...
|-------|-------|--------|----------|
| **token-health-check** | Token address + chain (Base/Solana) | Health verdict (GREEN/YELLOW/RED), risk factors, failure modes, recommendations, key points | Full due diligence analysis with AI-powered insights |
...
git clone https://github.com/seniorgrayman/inteliose.git
...
<p align="center">
  <strong>Built by <a href="https://github.com/seniorgrayman/inteliose">Inteliose Team</a></strong>
</p>
